...
import {
    ...
    Link as ChakraLink, useToast, Alert, AlertIcon, Checkbox,
    Flex, Divider, HStack
        ...
        <Flex minH="100vh" w="100vw" align="center" justify="center" bg="gray.50" px={4}>
            ...
            >
                <VStack spacing={2} mb={8}>
                    <Heading size="lg" color="gray.800" fontWeight="bold">¡Hola de nuevo!</Heading>
                    <Text color="gray.500" fontSize="sm">Ingresa tus datos para continuar.</Text>
                </VStack>
                ...
                <form onSubmit={handleLogin} style={{ width: '100%' }}>
                    <VStack spacing={5}>
                        ...
                        <Flex w="full" justify="space-between" align="center">
                            <Checkbox colorScheme="gray" defaultChecked><Text fontSize="sm" color="gray.600">Recordarme</Text></Checkbox>
                            <Text fontSize="sm" fontWeight="bold" color="gray.600" cursor="pointer">¿Olvidaste tu contraseña?</Text>
                        </Flex>
                ...
                <Text fontSize="sm" textAlign="center" color="gray.500" mt={8}>
                    ¿No tienes cuenta? <ChakraLink as={RouterLink} to="/register" color="gray.900" fontWeight="bold">Regístrate</ChakraLink>
                </Text>
            </MotionBox>
        </Flex>
    );
